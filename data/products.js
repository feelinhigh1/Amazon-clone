...
class Product {
  ...
  extraInfoHTML() { 
    return ``; // for normal product we dont need sizeChartLink so we return empty string
  }
}
...
class Clothing extends Product{ //Clothing will inherit every method and property from the product class
  ...
  extraInfoHTML() { // So, this method will generate some html that contains some extra information about this product 
    ...
    // super.extraInfoHTML(); // This calls parents method
...
console.log(date.toLocaleTimeString()); //gives current time 
*/
...
object3.method();  -> undefined as outside the object "this" is also undefined.
*/
